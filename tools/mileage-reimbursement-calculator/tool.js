(function(){
  ...
  var currentSlug = "mileage-reimbursement-calculator";
  ...
  function compute(v){
      const d=parseFloat(v.miles||'0'), r=parseFloat(v.rate||'0');
      const total=d*r;
      return 'Distance: '+d+' '+(v.unit||'Miles')+'\nReimbursement: '+total.toFixed(2);
    }
