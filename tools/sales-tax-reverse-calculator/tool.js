(function(){
  ...
  var currentSlug = "sales-tax-reverse-calculator";
  ...
  function compute(v){
      const t=parseFloat(v.total||'0'), r=parseFloat(v.rate||'0')/100;
      const pre=t/(1+r); const tax=t-pre;
      return 'Pre-tax amount: '+pre.toFixed(2)+'\nSales tax: '+tax.toFixed(2)+'\nTotal: '+t.toFixed(2);
    }
