(function(){
  ...
  var currentSlug = "dso-calculator";
  ...
  function compute(v){
      const ar=parseFloat(v.ar||'0'), r=parseFloat(v.revenue||'0'), d=parseFloat(v.days||'0');
      if(r<=0) return 'Enter revenue';
      const dso=(ar/r)*d;
      return 'DSO: '+dso.toFixed(1)+' days\nInterpretation: on average customers pay '+dso.toFixed(0)+' days after invoice';
    }
