(function(){
  ...
  var currentSlug = "hourly-to-salary-converter";
  ...
  var fields = ["hourly","hoursWeek","weeksYear"];
  var dateFields = [];
  ...
  function compute(v){
      const h=parseFloat(v.hourly||'0'), hw=parseFloat(v.hoursWeek||'0'), wy=parseFloat(v.weeksYear||'50');
      const annual=h*hw*wy; const monthly=annual/12; const weekly=h*hw;
      return 'Weekly: '+weekly.toFixed(2)+'\nMonthly: '+monthly.toFixed(2)+'\nAnnual: '+annual.toFixed(2);
    }
