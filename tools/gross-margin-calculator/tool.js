(function(){
  ...
  var currentSlug = "gross-margin-calculator";
  ...
  function compute(v){
      const R=parseFloat(v.revenue||'0'), C=parseFloat(v.cogs||'0');
      const profit=R-C; const margin=R>0?(profit/R)*100:0;
      return 'Gross profit: '+profit.toFixed(2)+'\nGross margin: '+margin.toFixed(1)+'%';
    }
