(function(){
  ...
  var currentSlug = "tip-calculator";
  ...
  function compute(v){
      const b=parseFloat(v.bill||'0'), t=parseFloat(v.tip||'0')/100, p=parseFloat(v.people||'1');
      const tipAmount=b*t; const total=b+tipAmount; const perPerson=p>0?total/p:total;
