(function(){
  ...
  var currentSlug = "tagline-generator";
  ...
  function compute(v){
      const b=(v.biz||'').trim(); if(!b) return 'Enter what your business does';
      const t=[
        'Made for people who care about '+b+'.',
        b+', reimagined.',
        'The last '+b+' brand you\'ll ever need.',
        b+' — done properly.',
        'Where '+b+' meets craft.',
        'Serious '+b+' for serious people.',
        'Your '+b+', simplified.',
        'The '+b+' revolution starts here.',
        b+' that lasts.',
        'For the love of '+b+'.',
        'Real '+b+'. No shortcuts.',
        'Better '+b+'. Every day.',
        b+' worth talking about.',
        'This is what '+b+' should feel like.',
        b+', on your terms.',
      ];
      return t.join('\n');
    }
