(function(){
  ...
  var currentSlug = "salary-to-hourly-converter";
  ...
  var fields = ["annual","hoursWeek","weeksYear"];
  var dateFields = [];
  ...
  function compute(v){
      const a=parseFloat(v.annual||'0'), hw=parseFloat(v.hoursWeek||'40'), wy=parseFloat(v.weeksYear||'50');
      const hours=hw*wy; const hourly=hours>0?a/hours:0;
      const weekly=a/wy; const monthly=a/12;
      return 'Hourly: '+hourly.toFixed(2)+'\nWeekly: '+weekly.toFixed(2)+'\nMonthly: '+monthly.toFixed(2);
    }
