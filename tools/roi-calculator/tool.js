(function(){
  ...
  var currentSlug = "roi-calculator";
  ...
  function compute(v){
      const c=parseFloat(v.cost||'0'), r=parseFloat(v.return||'0'), y=parseFloat(v.years||'1');
      if(c<=0) return 'Enter a valid investment amount';
      const profit=r-c; const roi=(profit/c)*100;
      const annualized=(Math.pow(r/c, 1/y)-1)*100;
