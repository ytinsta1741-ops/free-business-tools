(function(){
  ...
  var currentSlug = "sales-tax-calculator";
  ...
  function compute(v){
      ...
      const isPre=(v.mode||'').startsWith('Pre');
      const pre = isPre? a : a/(1+r);
      const tax = isPre? a*r : a - a/(1+r);
      const total = isPre? a*(1+r) : a;
      return 'Pre-tax: '+pre.toFixed(2)+'\nTax: '+tax.toFixed(2)+'\nTotal: '+total.toFixed(2);
    }
