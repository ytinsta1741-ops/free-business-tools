(function(){
  ...
  var currentSlug = "email-signature-generator";
  ...
  var fields = ["name","title","company","phone","email","website"];
  var dateFields = [];
  ...
  function compute(v){
      const parts=[v.name||'', v.title? (v.title+(v.company?' | '+v.company:'')) : (v.company||'')];
