(function(){
  ...
  var currentSlug = "commission-calculator";
  ...
  function compute(v){
      const s=parseFloat(v.sales||'0'), r=parseFloat(v.rate||'0')/100, b=parseFloat(v.base||'0');
      const commission=s*r; const total=commission+b;
      return 'Commission earned: '+commission.toFixed(2)+(b>0?'\nBase salary: '+b.toFixed(2)+'\nTotal compensation: '+total.toFixed(2):'');
    }
